...
=head1 process_qcstats.pl

Reformats the output QC data produced by three of the RSeQC RNA tools; http://rseqc.sourceforge.net (split_bam.py, geneBody_coverage.py and read_distribution.py) so that the metrics can be appended to the bas file generated by bamstats.

=head1 SYNOPSIS

process_qcstats.pl [options]
