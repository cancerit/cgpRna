...
const my @VALID_PROCESS => qw(createjunctionbed runbedpairtopair createbed annotatebed selectannotation output);
...
Produces a report of overlapping fusions that have been called by star-fusion or deFuse.
